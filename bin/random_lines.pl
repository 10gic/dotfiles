...
# Print random N lines from file
...
my($filename, $want) = @ARGV;
if ((not defined $filename) || (not defined $want)){
  die "Usage: random_lines.pl input-file n\n";
}
...
# From:
# https://stackoverflow.com/questions/29102589/get-random-lines-from-large-files-in-bash
#
# Konwn issue:
# Same line may be printed mutilple times
